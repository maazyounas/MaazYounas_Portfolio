...
const SystemMonitor = ({
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p
                    className={`text-2xl font-bold ${getStatusColor(status.cpu)}`}
                  >
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p
                    className={`text-2xl font-bold ${getStatusColor(status.memory)}`}
                  >
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p
                    className={`text-2xl font-bold ${getStatusColor(status.storage)}`}
                  >
  ...
  return (
    <div className="flex items-center gap-2">
      <div
        className={`hidden lg:flex items-center gap-4 px-4 py-2 rounded-lg ${
